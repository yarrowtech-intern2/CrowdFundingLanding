...
const BrowseInvestors = () => {
  return (
    <section id="investors" className="w-full bg-gradient-to-b from-[#f8faff] via-white to-[#f8faff] py-12 md:py-20 lg:py-16 xl:py-16 2xl:py-16">
      <div className="w-full max-w-[85rem] 2xl:max-w-7xl mx-auto px-6 sm:px-12 lg:px-20 grid grid-cols-1 lg:grid-cols-2 gap-12 sm:gap-16 lg:gap-16 xl:gap-16 2xl:gap-16 items-center">
        ...
        <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ amount: 0.2 }} transition={{ duration: 0.8 }} className="order-last lg:order-first">
          ...
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-[2.5rem] xl:text-[2.5rem] 2xl:text-[2.5rem] font-bold leading-[1.15] tracking-tight text-slate-900 mb-6 sm:mb-8">
            Fuel the Revolution. <br />
            <span className="text-indigo-600 italic font-serif pr-2">Invest in Global Greatness</span>
          </h2>

          <p className="text-sm sm:text-base md:text-lg lg:text-lg xl:text-xl 2xl:text-lg font-medium leading-relaxed text-slate-900 mb-12 max-w-lg lg:max-w-xl 2xl:max-w-2xl">
          ...
          <div className="space-y-8 sm:space-y-10 2xl:space-y-10">
            {[
              ...
              <motion.div 
                ...
                className="flex items-center gap-8 2xl:gap-8 group"
              >
                ...
                <div>
                  ...
                  <p className="text-sm sm:text-base lg:text-base xl:text-xl 2xl:text-sm font-medium text-slate-600 max-w-sm">{feature.desc}</p>
                </div>
              </motion.div>
            ))}
          </div>
