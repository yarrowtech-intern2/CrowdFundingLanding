...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full min-h-screen flex items-center justify-center bg-[#fdfdff] pt-14 sm:pt-16 md:pt-20 lg:pt-24 xl:pt-28 2xl:pt-24">
      <Helmet>
      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 relative z-10 py-8 sm:py-12 md:py-16 lg:py-20 2xl:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 lg:gap-14 xl:gap-20 2xl:gap-20 items-center">
          ...
          >
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/80 backdrop-blur-sm border border-indigo-100/50 shadow-sm mb-6 sm:mb-8 2xl:mb-6 w-fit mx-auto lg:mx-0">
            ...
            {/* Main Heading */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-6xl xl:text-7xl 2xl:text-5xl font-black leading-[1.15] tracking-tighter text-slate-900 mb-6 sm:mb-8 2xl:mb-6 px-2 sm:px-0">
            ...
            {/* Description */}
            <p className="text-base sm:text-lg md:text-lg lg:text-xl 2xl:text-lg font-medium leading-relaxed text-slate-700 max-w-2xl mx-auto lg:mx-0 mb-8 sm:mb-10 2xl:mb-8 px-2 sm:px-0">
          ...
          >
            <div className="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-2xl 2xl:max-w-xl animate-float">
              {/* Glow Background */}
        ...
        <div className="mt-16 sm:mt-20 md:mt-28 lg:mt-32 pt-12 sm:pt-16 md:pt-20 border-t border-indigo-100/50">
          ...
          <motion.h2 
            ...
            viewport={{ amount: 0.2 }} 
            className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl xl:text-6xl 2xl:text-4xl font-bold tracking-tight text-slate-900 text-center mb-12 sm:mb-16 md:mb-20 2xl:mb-14 px-2 sm:px-0"
          >
            Three Simple Steps
          </motion.h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 md:gap-10 2xl:gap-10 px-2 sm:px-0">
            {[
              ...
              <motion.div 
                ...
                className="group p-6 sm:p-8 md:p-10 2xl:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-indigo-50/50 to-transparent hover:bg-white hover:shadow-2xl transition-all duration-300 border border-transparent hover:border-indigo-100/50"
              >
                {/* Icon Container */}
