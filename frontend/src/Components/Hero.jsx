...
const Hero = () => {
  ...
  return (
    <section id="home" className="relative w-full bg-[#fdfdff] pt-20 overflow-visible">
      ...
      <div className="relative w-full min-h-[calc(100vh-80px)] flex items-center justify-center px-4 sm:px-6 md:px-8 lg:px-12 py-10">
      ...
      <div className="relative w-full bg-white py-16 sm:py-24 2xl:py-20 border-t border-indigo-100/50 overflow-visible z-10">
        <div className="w-full max-w-7xl mx-auto px-6 sm:px-12 lg:px-20">
          ...
          <motion.h2 
            ...
            viewport={{ amount: 0.2 }} 
            className="text-3xl sm:text-4xl md:text-4xl lg:text-4xl xl:text-4xl 2xl:text-4xl font-bold tracking-tight text-slate-900 text-center mb-10 sm:mb-12 md:mb-16 2xl:mb-16"
          >
            Three Simple Steps
          </motion.h2>

          {/* Steps Grid */}
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 2xl:gap-10">
            {[
              { 
                id: "01", 
                icon: <UserPlus />, 
              ...
              <motion.div 
                ...
                className="group p-8 sm:p-10 2xl:p-10 rounded-2xl sm:rounded-3xl bg-gradient-to-br from-indigo-50/50 to-transparent hover:bg-white hover:shadow-2xl transition-all duration-300 border border-transparent hover:border-indigo-100/50"
              >
                {/* Icon Container */}
