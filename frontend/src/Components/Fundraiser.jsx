...
const FundraiserSection = () => {
  return (
    <section
      id="fundraise"
      className="w-full bg-gradient-to-b from-[#f8f9ff] via-[#f3f5ff] to-[#eef2ff] flex items-center overflow-hidden py-16 sm:py-20 md:py-28"
    >
      <div className="w-full max-w-7xl xl:max-w-[88rem] mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
        ...
        >
          ...
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold tracking-tight text-[#1e2b4f] leading-[1.1] mb-4 sm:mb-6">
            Ignite Your Ambition.{" "}
            <br className="hidden md:block" />
            <span className="text-[#2e66ff] italic">Architect the Future</span>
          </h1>

          <p className="text-sm sm:text-[15px] md:text-lg text-gray-600 leading-relaxed mb-4 sm:mb-6 max-w-lg lg:max-w-xl xl:max-w-2xl">
