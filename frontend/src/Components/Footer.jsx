    ...
    <footer className="bg-[#0f172a] text-slate-400 py-12 md:py-16 relative overflow-hidden">
      ...
      <div className="w-full max-w-7xl 2xl:max-w-[90rem] mx-auto px-4 sm:px-8 md:px-12 lg:px-16 2xl:px-20 relative z-10">
        ...
        <motion.div
          ...
          className="pt-10 border-t border-slate-800/30 flex flex-col sm:flex-row justify-between items-center gap-6 text-[10px] font-bold uppercase tracking-[0.2em] text-slate-500"
        >
